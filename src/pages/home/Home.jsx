            ...
            <div className=" font-Inter">
                    ...
                    <div className="grid md:grid-cols-2 items-center md:gap-8 gap-6">
                        <div className="max-md:order-1 max-md:text-center z-50 relative">
                            <h2 className="text-gray-800 lg:text-6xl md:text-5xl text-3xl font-extrabold mb-4 md:!leading-[56px]">
                                <span className="text-[#537AF6]">Share</span>{' '}
                                File with{' '}
                                <span className="text-[#537AF6]">Sharify</span>
                            </h2>
                            ...
                            <button
                                type="button"
                                className="mt-6 bg-[#537AF6] hover:bg-transparent hover:text-[#537AF6] border-2 border-[#537AF6] transition-all text-white font-semibold text-sm tracking-wide rounded-md px-6 py-2.5"
                            >
                                Get Started
                            </button>
                    ...
                    <div className="grid md:grid-cols-3 gap-4 z-50 relative md:px-4 max-md:mt-12 mb-12">
                        <div className="bg-white p-6 shadow rounded-md">
                            ...
                            <a
                                ...
                                className="text-[#537AF6] font-bold inline-block text-sm hover:underline mt-4"
                            >
                                Learn more
                            </a>
                        </div>
                ...
                <div className="grid md:grid-cols-3 gap-6 min-h-[164px] py-8 my-8 p-16 bg-gradient-to-r from-[#537AF6] to-blue-300 font-sans overflow-hidden">
                    <div className="md:col-span-2">
                        ...
                        <p className="text-base text-gray-200 mt-4">
                            Best file sharing plateform
                        </p>

                        <button
                            type="button"
                            className="py-3 px-6 text-sm font-semibold bg-white text-[#537AF6] hover:bg-slate-100 rounded-md mt-8"
                        >
                            Get Started
                        </button>
                    </div>
                        ...
                        <div class="grid lg:grid-cols-3 sm:grid-cols-2 gap-6 mt-12 max-sm:max-w-sm max-sm:mx-auto">
                            <div class="border rounded-md p-6">
                                ...
                                <div class="mt-6">
                                    <h3 class="text-gray-800 text-2xl font-semibold">
                                        $10{' '}
                                        <sub class="text-gray-500 text-sm font-medium">
                                            per month
                                        </sub>
                                    </h3>
                                </div>
                                ...
                                <div class="mt-6">
                                    <h4 class="text-gray-800 text-xl font-semibold mb-2">
                                        Include
                                    </h4>
                                    <p class="text-sm text-gray-500">
                                    ...
                                    <button
                                        type="button"
                                        class="w-full mt-6 px-5 py-2.5 text-sm text-white bg-[#537AF6] hover:bg-[#537AF6] rounded-md"
                                    >
                                        Buy now
                                    </button>
                                </div>
                            ...
                            <div class="border rounded-md p-6">
                                <h3 class="text-gray-800 text-xl font-semibold mb-2 flex items-center">
                                    Professional{' '}
                                    <span class="px-2 py-1 text-xs font-semibold text-white bg-[#537AF6] rounded-md ml-3">
                                        Best Deal
                                    </span>
                                </h3>
                                <p class="text-sm text-gray-500">
                ...
                <div class="flex gap-4 max-sm:flex-col my-8 items-center justify-center text-center bg-[#537AF6] text-white px-6 py-3.5  font-[sans-serif]">
                    ...
                    <div class="flex gap-2">
                        <button
                            type="button"
                            class="bg-white text-[#537AF6] py-2.5 px-5 rounded text-sm hover:underline"
                        >
                            Learn More
                        </button>
                    </div>
                            ...
                            <div class="border rounded-lg overflow-hidden">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="space-x-4 mt-4">
                                        ...
                                        <button
                                            type="button"
                                            class="w-6 h-6 inline-flex items-center justify-center rounded-full border-none outline-none bg-[#537AF6] hover:bg-[#03a1f4]"
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="14px"
                                            ...
                                            >
                                                <path
                                                    ...
                                                    data-original="#537AF6"
                                                />
                                            </svg>
                                        </button>
                                        <button
                                            type="button"
                                            class="w-6 h-6 inline-flex items-center justify-center rounded-full border-none outline-none bg-[#537AF6] hover:bg-[#0055b5]"
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="14px"
                ...
                <div class="grid sm:grid-cols-2 items-start gap-16 p-4 mx-auto max-w-4xl bg-white font-[sans-serif]">
                        ...
                        <div class="mt-12">
                            ...
                            <ul class="mt-4">
                                <li class="flex items-center">
                                    ...
                                    <a
                                        href="javascript:void(0)"
                                        class="text-[#537AF6] text-sm ml-4"
                                    >
                    ...
                    <form class="ml-auto space-y-4">
                        <input
                            type="text"
                            placeholder="Name"
                            class="w-full rounded-md py-3 px-4 bg-gray-100 text-gray-800 text-sm outline-[#537AF6] focus:bg-transparent"
                        />
                        <input
                            type="email"
                            placeholder="Email"
                        ...
                        <textarea
                            placeholder="Message"
                            rows="6"
                            class="w-full rounded-md px-4 bg-gray-100 text-gray-800 text-sm pt-3 outline-[#537AF6] focus:bg-transparent"
                        ></textarea>
                        <button
                            type="button"
                            class="text-white bg-[#537AF6] hover:bg-blue-600 tracking-wide rounded-md text-sm px-4 py-3 w-full !mt-6"
                        >
                            Send
                        </button>
                    </form>
