            ...
            <div class="grid sm:grid-cols-2 items-start gap-16 p-4 mx-auto max-w-4xl bg-white font-[sans-serif]">
                        ...
                        <ul class="mt-4">
                            <li class="flex items-center">
                                <div class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#537AF6'
                                ...
                                <a href="javascript:void(0)" class="text-[#537AF6] text-sm ml-4">
                ...
                <form class="ml-auto space-y-4">
                    ...
                    <textarea placeholder='Message' rows="6"
                        class="w-full rounded-md px-4 bg-gray-100 text-gray-800 text-sm pt-3 outline-[#537AF6] focus:bg-transparent"></textarea>
                    <button type='button'
                        class="text-white bg-[#537AF6] hover:bg-blue-600 tracking-wide rounded-md text-sm px-4 py-3 w-full !mt-6">Send</button>
                </form>
            </div>
        </div>
    )
